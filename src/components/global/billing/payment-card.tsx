...
const PayementCard = ({ label, current, landing }: Props) => {
  return (
    <div
      className={cn(
        label !== current
    ...
    >
      <div
        className={cn(
          ...
          "flex flex-col rounded-xl pl-5 py-5 pr-10 bg-neutral-900"
        )}
      >
        {landing ? (
        ...
        {label === "PRO" ? (
          ...
          <p className="font-bold mt-2 text-gray-200">Standard</p>
        )}
        {label === "PRO" ? (
          <p className="mb-2">
            <b className="text-xl">$99.9</b>
            /month
          </p>
        ) : (
